...
$sql =  $mysqli->query( "UPDATE tbMembers SET first_name='$myFirstName', last_name='$myLastName', email='$myEmail', password='$newpass' WHERE member_id = '$myId'" )
        or die( mysqli_error() );
...
<div id="header">
  ...
  <a href="student.php">Home</a> | <a href="vote.php">Current Polls</a> | <a href="manage-profile.php">Manage My Profile</a> |<a href="http://localhost/online%20voting/online_voting/realtime/chartjs-master/php-mysql-chartjs/bargraph.html">View Realtime Results</a> | <a href="logout.php">Logout</a>
</div>
<div id="container">
<table>
<tr>
